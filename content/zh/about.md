...
已在 CVPR、ICLR、NeurIPS、ICRA、RSS、IROS、CoRL 等顶级会议发表论文 10 篇，其中第一作者/共同第一作者论文发表于 CVPR 2026、NeurIPS 2025 和 CVPR 2025。研究涵盖统一 VLA 架构、面向快速操控的双系统基础模型以及面向鲁棒机器人控制的三维表示学习。
